...
/* Funktion som körs vid socket-händelsen "newGame" 
...
socket.on('newGame', function (data) {
    ...
    players.setAttribute('style', 'background-color: ' + unescape(data.opponentColor));  
    globalObject.opponentColor = unescape(data.opponentColor); // Spara motståndares färg i globalObject
    globalObject.myColor = unescape(data.myColor); // Spara klientens valda färg i globalObject
...
/* Funktion som körs vid socket-händelsen "yourMove"
   Tar emot data som en JSON-sträng innehållande värdeparen:
...
/* Funktion som körs vid socket-händelsen "gameover"
...
/* Funktion som körs vid timeouthändelse
   Tar inget invärde. Inget returvärde
*/
